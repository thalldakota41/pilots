...
class index(ListAPIView):
    def get(self, request):
        ...
        # prefetch related is a performance booster filter that follows 'manytomany' and 'manytoone' relationships minimizing the calls being made to the db. 
        post =  Show.objects.all().prefetch_related('creators')
        ...
        for lists in post:            
            ...
            #appends all search results to empty api_data dict from the loop.
            api_data[api_title] = {'poster_path':api_poster, 'id':api_id} 
